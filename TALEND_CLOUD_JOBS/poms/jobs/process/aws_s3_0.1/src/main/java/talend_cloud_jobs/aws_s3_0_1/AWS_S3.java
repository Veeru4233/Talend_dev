...
package talend_cloud_jobs.aws_s3_0_1;
...
/**
 * Job: AWS_S3 Purpose: <br>
 * Description: <br>
 * 
 * @author kumar k, veeresh
 * @version 8.0.1.20230612_1054-patch
 * @status
 */
public class AWS_S3 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "AWS_S3.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(AWS_S3.class);
	...
	private final String jobName = "AWS_S3";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(AWS_S3.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tPrejob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "1TxyDW_" + subJobPidCounter.getAndIncrement());
	...
	public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "aKYx93_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tS3Connection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tS3Connection_1.append("ACCESS_KEY" + " = " + "\"AKIATRUWDO3O52775XNX\"");
							log4jParamters_tS3Connection_1.append(" | ");
							log4jParamters_tS3Connection_1.append("SECRET_KEY" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:h/591a/3hECDEjPSwuEoRKF54nAeafXGTatPbGrrkUaSQu7lBG5PSmXOzOiu+SDqZWV4LvHpQNcBKa8XpbkrR+wKV84=")
									.substring(0, 4) + "...");
							log4jParamters_tS3Connection_1.append(" | ");
							log4jParamters_tS3Connection_1.append("ASSUME_ROLE" + " = " + "false");
							log4jParamters_tS3Connection_1.append(" | ");
							log4jParamters_tS3Connection_1.append("REGION" + " = " + "\"us-east-1\"");
							log4jParamters_tS3Connection_1.append(" | ");
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:207Z3M5bisvnSO0FHGjoYRW3TtRf4jehRA63ny9VU61cGgp0A8d+8d8IWtJxLW0ehkacaXdMinohJFKEtaUp6pi40Fc=");

				com.amazonaws.auth.AWSCredentials credentials_tS3Connection_1 = new com.amazonaws.auth.BasicAWSCredentials(
						"AKIATRUWDO3O52775XNX", decryptedPassword_tS3Connection_1);
				...
				if (useRegionEndpoint_tS3Connection_1 && regionEndpoint_tS3Connection_1 != null
					...
					builder_tS3Connection_1.withEndpointConfiguration(
							new com.amazonaws.client.builder.AwsClientBuilder.EndpointConfiguration(
									regionEndpoint_tS3Connection_1, "us-east-1"));
				} else {
					builder_tS3Connection_1.withRegion("us-east-1");
				}
	...
	public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdcInfo.forEach(org.slf4j.MDC::put);
		org.slf4j.MDC.put("_subJobName", "tS3Get_1");
		org.slf4j.MDC.put("_subJobPid", "ePTX8D_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled())
					log.debug("tS3Get_1 - " + ("Start to work."));
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tS3Get_1 {
						public void limitLog4jByte() throws Exception {
							StringBuilder log4jParamters_tS3Get_1 = new StringBuilder();
							log4jParamters_tS3Get_1.append("Parameters:");
							log4jParamters_tS3Get_1.append("USE_EXISTING_CONNECTION" + " = " + "true");
							log4jParamters_tS3Get_1.append(" | ");
							log4jParamters_tS3Get_1.append("CONNECTION" + " = " + "tS3Connection_1");
							log4jParamters_tS3Get_1.append(" | ");
							log4jParamters_tS3Get_1.append("BUCKET" + " = " + "\"veeruetl\"");
							log4jParamters_tS3Get_1.append(" | ");
							log4jParamters_tS3Get_1.append("KEY" + " = " + "\"test/employe.txt\"");
							log4jParamters_tS3Get_1.append(" | ");
							log4jParamters_tS3Get_1.append("FILE" + " = "
									+ "\"C:/Talend/Talend-Studio-20230428_0423-V8.0.1/Talend-Studio-20230428_0423-V8.0.1/workspace/S3.csv\"");
							log4jParamters_tS3Get_1.append(" | ");
							log4jParamters_tS3Get_1.append("DIE_ON_ERROR" + " = " + "true");
							log4jParamters_tS3Get_1.append(" | ");
							log4jParamters_tS3Get_1.append("USE_SELECT" + " = " + "false");
							log4jParamters_tS3Get_1.append(" | ");
							log4jParamters_tS3Get_1.append("USE_TEMP_FILES_FOR_PARALLEL_DOWNLOAD" + " = " + "false");
							log4jParamters_tS3Get_1.append(" | ");
							if (log.isDebugEnabled())
								log.debug("tS3Get_1 - " + (log4jParamters_tS3Get_1));
						}
					}
					new BytesLimit65535_tS3Get_1().limitLog4jByte();
				}
				if (enableLogStash) {
					talendJobLog.addCM("tS3Get_1", "tS3Get_1", "tS3Get");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					log.info("tS3Get_1 - Getting an object with key:" + "test/employe.txt");
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "aGsygN_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final AWS_S3 AWS_S3Class = new AWS_S3();

		int exitCode = AWS_S3Class.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'AWS_S3' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'AWS_S3' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_p85hgCYAEe6ohqJ194whuQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-07-19T16:35:52.113054800Z");
		...
		try {
			...
			java.io.InputStream inContext = AWS_S3.class.getClassLoader()
					.getResourceAsStream("talend_cloud_jobs/aws_s3_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = AWS_S3.class.getClassLoader()
		...
		log.info("TalendJob: 'AWS_S3' - Started.");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : AWS_S3");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'AWS_S3' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 59349 characters generated by Talend Cloud Data Management Platform on the 19
 * July 2023 at 10:05:52 pm IST
 ************************************************************************************************/